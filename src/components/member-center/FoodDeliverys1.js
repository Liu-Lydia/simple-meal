...
function FoodDeliverys1() {
  ...
  const getDataFromServer = async () => {
    ...
    const response = await fetch(
      `http://localhost:4000/membercenter/history_mealdelivery?start=${FoodDeliverySeach}&end=${FoodDeliverySeach1}&status=0`,
      {
        method: 'get',
        credentials: 'include',
      }
